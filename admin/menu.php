                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="admin-action-buttons">
                                        <a href="<?php echo qb_url('admin/edit-menu.php?id=' . $item['id']); ?>" class="btn btn-light">Edit</a>
                                        <a href="<?php echo qb_url('admin/delete-menu.php?id=' . $item['id']); ?>" class="btn btn-danger" onclick="return confirm('Delete this meal?');">Delete</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endwhile; ?>
